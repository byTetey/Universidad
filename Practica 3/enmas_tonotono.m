function varargout = enmas_tonotono(varargin)
% ENMAS_TONOTONO M-file for enmas_tonotono.fig
%      ENMAS_TONOTONO, by itself, creates a new ENMAS_TONOTONO or raises the existing
%      singleton*.
%
%      H = ENMAS_TONOTONO returns the handle to a new ENMAS_TONOTONO or the handle to
%      the existing singleton*.
%
%      ENMAS_TONOTONO('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ENMAS_TONOTONO.M with the given input arguments.
%
%      ENMAS_TONOTONO('Property','Value',...) creates a new ENMAS_TONOTONO or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before enmas_tonotono_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to enmas_tonotono_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help enmas_tonotono

% Last Modified by GUIDE v2.5 27-Oct-2008 13:00:16

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @enmas_tonotono_OpeningFcn, ...
                   'gui_OutputFcn',  @enmas_tonotono_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before enmas_tonotono is made visible.
function enmas_tonotono_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to enmas_tonotono (see VARARGIN)

% Choose default command line output for enmas_tonotono
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes enmas_tonotono wait for user response (see UIRESUME)
...
axes(handles.axes1); 
temptext1=text(f1,10*log10(a1^2/2),'\bullet','Color','r','FontSize',24,'HorizontalAlignment','center');
...
function varargout = enmas_tonotono_OutputFcn(hObject, eventdata, handles) 
